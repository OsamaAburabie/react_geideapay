...
export default class Order {
  ...
  constructor(opts) {
    ...
    let transactions =
      opts && "transactions" in opts ? opts.transactions : null;
  ...
  static fromJson(map) {
    ...
    let agreementType =
      map && "agreementType" in map ? map.agreementType : null;
    let paymentOperation =
    ...
    let setDefaultPaymentMethod =
      map && "setDefaultPaymentMethod" in map
        ...
        : null;
    let restrictPaymentMethods =
      map && "restrictPaymentMethods" in map
        ? map.restrictPaymentMethods
        : null;
    let createCustomer =
    ...
    let paymentIntent =
      map && "paymentIntent" in map ? map.paymentIntent : null;
    let paymentMethod =
      map && "paymentMethod" in map ? map.paymentMethod : null;
    let statementDescriptor =
